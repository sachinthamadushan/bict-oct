        ...
        <div class="offcanvas offcanvas-start text-bg-warning" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    <li class="nav-item">
                        <a class="nav-link hover-bg-primary" aria-current="page" href="<?php echo BASE_URL; ?>">
                            <i class="fa fa-home" aria-hidden="true"></i> Home
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link hover-bg-primary" href="<?php echo BASE_URL; ?>pages/categoery.php">
                            <i class="fa fa-th-list" aria-hidden="true"></i> Vehicle
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link hover-bg-primary" href="<?php echo BASE_URL; ?>pages/rent_item.php">
                            <i class="fa fa-television"></i> Rent Items
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link hover-bg-primary" href="#">
